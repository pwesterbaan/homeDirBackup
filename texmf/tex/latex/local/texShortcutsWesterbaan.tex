%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Accessibility hacks experiments
%Hack to create a blank \tikzsetnextfilename when not using externalize
\ifdefined\tikzsetnextfilename\else
  \newcommand{\tikzsetnextfilename}[1]{}
\fi
%Hack for alt text for tikz figures
\ifdefined\HCode
  \newcommand*{\tikzalt}[1]{\tikzset{alt={PS: #1}}}
\else
  \newcommand*{\tikzalt}[1]{}
 \tikzset{alt/.code={\pgfkeysalso{}}}
\fi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\exitSlipQuestionTemplate}[2][]{
  \large %12pt
  \vspace*{0.5in}
  \noindent Exit slip #1 \hspace*{\stretch{1}}
  \className \hspace*{\stretch{1}}
  Name: \fillin[\hfill\textbf{KEY}\hfill][40mm]\\[5pt]
  #2%
