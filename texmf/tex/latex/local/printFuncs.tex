...
\keys_define:nn { printCoeff }
  {
    ...
    fmt         .meta:n           = { format }, %alias for format
    %
      ...
      \fp_compare:nNnF { ##1 } = {0}{
        ...
        {  %print w/o leading +
          \fp_compare:nNnTF { \l__printpoly_expo } = {0}{
            \fp_compare:nNnTF { \l__printpoly_coeff } = {-1}{
              ...
              \printCoeff[one]{ \l__printpoly_coeff }
            }{
              \printCoeff*{ \l__printpoly_coeff }
            }
          }{
            \printCoeff*{ \l__printpoly_coeff }
          }
        ...
        \fp_compare:nNnF { \l__printpoly_expo } = {0}{
          ...
          \fp_compare:nNnF { \l__printpoly_expo } = {1}{
            \ensuremath{^{ \printCoeff[noplus,one]{\l__printpoly_expo }}}
          }
        }
      }
  }
