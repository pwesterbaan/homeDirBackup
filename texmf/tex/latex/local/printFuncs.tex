...
%TODO: add option to replace parens  (e.g. [] instead of () )
%TODO: add option to replace delims  (e.g. ; instead of , )
...
\cs_new_protected:Npn \print_coord:nn #1 #2
  {
    ...
    \clist_map_inline:nn { #2 }
      {
        \bool_if:NF \l__coord_firstTerm_bool { \ensuremath{,} }
        \printNum* [one, zero, #1] { ##1 }
