...
\begin{document}
  \begin{description}
\item[Make--Up Policy:] ``Make--up'' exams are not likely and are to not be expected. Whether or not an exam can be made up is at the discretion of the instructor. If a ``make--up'' exam is granted, it must be completed within 2 class meetings of the original exam and are given at the discretion of the instructor.
...
\item[Reference to Lander’s ADA policy:]
  Lander University recognizes its responsibility for creating an institutional climate where students with disabilities can thrive. If you have any type of disability that requires accommodations, please contact the Student Success Center at \href{mailto:accessibilityservices@lander.edu}{accessibilityservices\allowbreak@lander.edu} or (864) 388-8308 to discuss your needs. Once the Student Success Center has received appropriate documentation, your instructors will be informed of approved accommodations.
