...
fs_x=disc_x+2*x_sep
fs_y=disc_y+2*y_sep
batt_x=disc_x+3*x_sep
batt_y=disc_y+3*y_sep
network_x=disc_x+4*x_sep
network_y=disc_y+4*y_sep
networkMaxScale=7.5
...
function draw_graduations(display)
    ...
    local graduation_radius = 56
    local graduation_thickness, graduation_mark_thickness = 12.5, 0.90
